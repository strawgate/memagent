...
fn run_profile(fixture: &FixtureData, mode: Mode, iterations: usize) -> ProfileResult {
    ...
    if matches!(
        mode,
        Mode::E2eProst | Mode::E2eProjectedDetached | Mode::E2eProjectedView
    ) {
        let batch = decode_protobuf_to_batch_projected_experimental(&fixture.payload)
