...
//! type is marked `#[ffwd_lint_attrs::owned_by_actor]`.
//!
//! Usage model: attribute goes on a **type definition** (struct or enum).
//! The proc-macro prepends `#[doc = "__ffwd_owned_by_actor__"]`
...
rustc_session::declare_lint! {
    ...
    /// `ffwd-runtime`) will produce noisy true-positives and should
    /// be left untagged.
    ///
    ...
    /// roadmap item in `crates/ffwd-lints/README.md`.
...
const OWNED_BY_ACTOR_MARKER: &str = "__ffwd_owned_by_actor__";
