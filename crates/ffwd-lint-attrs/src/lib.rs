...
//! `#[doc = "__ffwd_<name>__"]` marker to its input and returns the
//! result. The dylint lint library (`crates/ffwd-lints/`) finds the
...
pub fn hot_path(_attr: TokenStream, item: TokenStream) -> TokenStream {
    prepend_marker("__ffwd_hot_path__", item)
}
...
pub fn cancel_safe(_attr: TokenStream, item: TokenStream) -> TokenStream {
    prepend_marker("__ffwd_cancel_safe__", item)
}
...
pub fn no_panic(_attr: TokenStream, item: TokenStream) -> TokenStream {
    prepend_marker("__ffwd_no_panic__", item)
}
...
pub fn pure(_attr: TokenStream, item: TokenStream) -> TokenStream {
    prepend_marker("__ffwd_pure__", item)
}
