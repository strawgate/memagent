...
//!
//! Run:
//!   cargo test -p ffwd-core --test scanner_conformance
//!
//! Scale up (10K+ cases):
//!   PROPTEST_CASES=10000 cargo test -p ffwd-core --test scanner_conformance
//!
//! Find minimal failing case:
//!   cargo test -p ffwd-core --test scanner_conformance -- --nocapture
...
use ffwd_test_utils::json::{arb_flat_object, arb_json_string, arb_ndjson_buffer};
...
// ===========================================================================
// proptest generators — shared from ffwd-test-utils
// ===========================================================================
...
proptest! {
    #![proptest_config(ProptestConfig::with_cases(ffwd_test_utils::proptest_cases()))]
