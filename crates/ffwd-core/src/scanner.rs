...
//
// Provides the ScanBuilder trait shared by ffwd-core's streaming JSON
// scanner and the Arrow-specific builders in ffwd-arrow.
...
///
/// Implementations live in `ffwd-arrow` (`StreamingBuilder`).
