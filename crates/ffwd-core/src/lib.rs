//! Proven pure-logic kernel for ffwd.
//!
...
// add branches in the hot path. Phase 2 (work-unit #2626) adds per-site #[allow] with
// invariant comments. Phase 3 escalates indexing_slicing to deny.
