            ...
            let result = (|| -> Result<(), ConfigError> {
                ...
                for (i, output) in pipe.outputs.iter().enumerate() {
                    ...
                    match output.output_type {
                        ...
                        // Parquet is not yet implemented — already rejected by
                        // the check above; this arm is unreachable but required
                        // for exhaustiveness.
                        // Http is now implemented; validation is handled above.
