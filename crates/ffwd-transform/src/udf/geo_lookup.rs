...
///
/// ```rust,no_run
/// use ffwd_transform::enrichment::GeoDatabase as _;
/// use ffwd_transform::udf::geo_lookup::MmdbDatabase;
///
/// let db = MmdbDatabase::open("/etc/ffwd/GeoLite2-City.mmdb").unwrap();
