...
mod tests {
    ...
    #[test]
    fn production_fallback_matches_prost_for_unsupported_anyvalue() {
        ...
        let actual = crate::otlp_receiver::decode_protobuf_to_batch(&payload)
            .expect("production decoder should fall back to prost");
