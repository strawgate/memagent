...
pub(super) const RESOURCE_FIELDS: &[FieldRule] = &[FieldRule {
    number: 1,
    name: "attributes",
    expected_wire: WireKind::Len,
    action: ProjectionAction::Descend,
...
fn lookup_field(message: MessageKind, number: u32) -> Option<&'static FieldRule> {
    match message {
        ...
        MessageKind::LogRecord => match number {
            ...
            8 => Some(&LOGRECORD_FIELDS[5]),
            9 => Some(&LOGRECORD_FIELDS[6]),
            10 => Some(&LOGRECORD_FIELDS[7]),
            11 => Some(&LOGRECORD_FIELDS[8]),
            _ => None,
        },
