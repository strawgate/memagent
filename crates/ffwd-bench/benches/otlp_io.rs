...
use ffwd_bench::generators::otlp::{self, OtlpFixtureProfile};
use ffwd_bench::{generators, make_otlp_sink};
...
fn build_fixture(profile: OtlpFixtureProfile) -> FixtureData {
    ...
    let detached_projected_fallback = ffwd_arrow::materialize::detach(&projected_fallback_batch);
    ...
    let detached_view_batch = ffwd_arrow::materialize::detach(&view_batch);
