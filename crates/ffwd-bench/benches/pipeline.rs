//! Criterion benchmarks for the ffwd pipeline.
//!
//! Run with: cargo bench -p ffwd-bench
//! JSON output: cargo bench -p ffwd-bench -- --output-format bencher 2>/dev/null
...
use ffwd_output::{ElasticsearchRequestMode, ElasticsearchSinkFactory};
    ...
    group.bench_function("json_serialize", |b| {
        ...
        b.iter(|| {
            ...
            for row in 0..batch.num_rows() {
                ffwd_output::write_row_json(&batch, row, &cols, &mut buf, true)
