...
//! Sustained-load memory profiler for the ffwd pipeline.
//!
...
//!
//! Run with: `cargo run -p ffwd-bench --release --bin memory-profile [duration_secs]`
...
fn main() {
    ...
    let mut null_sink = ffwd_bench::NullSink;
