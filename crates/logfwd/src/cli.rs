...
impl BlastDestination {
    pub(crate) fn as_output_type(self) -> logfwd_config::OutputType {
        match self {
...
impl DevourMode {
    ...
    pub(crate) fn spec(self) -> logfwd_runtime::generated_cli::DevourModeSpec {
        match self {
...
impl SendFormat {
    pub(crate) fn as_config_format(self) -> logfwd_config::Format {
        match self {
