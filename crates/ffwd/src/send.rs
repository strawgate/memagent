...
";
        ...
        assert_eq!(input.input_type(), ffwd_config::InputType::Stdin);
        assert_eq!(input.format, Some(ffwd_config::Format::Json));
        assert_eq!(
            pipeline
                .resource_attrs
                .get("service.name")
...
";
        ...
        assert_eq!(pipeline.inputs[0].format, Some(ffwd_config::Format::Raw));
        ...
        match &pipeline.enrichment[..] {
            [ffwd_config::EnrichmentConfig::Static(static_cfg)] => {
