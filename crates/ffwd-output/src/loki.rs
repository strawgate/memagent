...
//!   "streams": [
//!     {
//!       "stream": {"app":"ffwd","namespace":"default"},
...
impl LokiSink {
    ...
    fn build_stream_map(
        ...
        //   1. `_timestamp`  — ffwd canonical pipeline column
...
mod tests {
    ...
    fn send_failure_rolls_back_timestamp_reservation() {
        ...
        let factory = LokiSinkFactory::new(
            ...
            server.url(),
            None,
            vec![("app".to_string(), "ffwd".to_string())],
            vec![],
            vec![],
        ...
        let labels: StreamLabels = vec![("app".to_string(), "ffwd".to_string())];
        {
