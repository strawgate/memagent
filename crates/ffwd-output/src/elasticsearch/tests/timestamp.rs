...
///
/// Run with:
/// `cargo test -p ffwd-output elasticsearch::tests::bench_write_ts_suffix_fast_vs_simple --release -- --ignored --nocapture`
#[test]
...
///
/// Run with:
/// `cargo test -p ffwd-output elasticsearch::tests::bench_serialize_batch_fast_vs_simple --release -- --ignored --nocapture`
#[test]
#[ignore = "microbenchmark"]
