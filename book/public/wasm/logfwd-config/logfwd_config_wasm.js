 ...
 */
export function get_input_snippet(id) {
    const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_input_snippet(ptr0, len0);
    let v2;
    if (ret[0] !== 0) {
 ...
 * @returns {any}
 */
export function get_input_templates() {
    const ret = wasm.get_input_templates();
    return ret;
}
 ...
 * @returns {string | undefined}
 */
export function get_output_snippet(id) {
    const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_output_snippet(ptr0, len0);
    let v2;
    if (ret[0] !== 0) {
        v2 = getStringFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
 ...
 * @returns {any}
 */
export function get_output_templates() {
    const ret = wasm.get_output_templates();
    return ret;
}
 ...
 * @returns {any}
 */
export function get_use_case_templates() {
    const ret = wasm.get_use_case_templates();
    return ret;
}
 ...
 * @param {string} transform_sql
 * @returns {string}
 */
export function render_config(input_id, output_id, transform_sql) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(input_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(output_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(transform_sql, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.render_config(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @param {string} yaml
 */
export function validate_config(yaml) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./logfwd_config_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('logfwd_config_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
