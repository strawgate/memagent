...
|-------|-------------------|
| [Pipeline Design](/memagent/how-it-works/pipeline/) | Data flow, persistence modes, end-to-end ack semantics, multi-source pipelines |
| [Scanner](/memagent/how-it-works/scanner/) | SIMD structural indexing, zero-copy StringViewArray, field pushdown |
| [Performance](/memagent/how-it-works/performance/) | Benchmarks (2.8M lines/sec), stage breakdown, memory profile |
| [YAML Reference](/memagent/configuration/reference/) | Every YAML field, input/output type, and option |
