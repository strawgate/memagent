...
YAML Reference for [inputs](/memagent/configuration/reference/#input-types)
and [outputs](/memagent/configuration/reference/#output-types). This architecture
guide focuses on data flow and system shape rather than duplicating per-surface
availability claims.
