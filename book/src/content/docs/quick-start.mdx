---
title: "Quick Start"
description: "Install FastForward, run your first pipeline, and ship logs in about 15 minutes"
---
...
:::note
The product is **FastForward**. The GitHub repository is named `memagent` for historical reasons. Docker images, URLs, and `git clone` commands reference `memagent`; the binary is currently named `logfwd` and will be renamed to `ff` in a future release.
:::
