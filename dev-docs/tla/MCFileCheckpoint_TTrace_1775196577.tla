---- MODULE MCFileCheckpoint_TTrace_1775196577 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MCFileCheckpoint_TTrace_1775196577.json", _TETrace)
...
\*
\*trace == IODeserialize("MCFileCheckpoint_TTrace_1775196577.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([read_offset |-> 0,file_content |-> <<>>,next_line_id |-> 2,alive |-> TRUE,checkpoint_gen |-> 1,rotated_content |-> <<>>,rotation_count |-> 1,rotated_active |-> FALSE,in_flight_offset |-> 1,checkpoint_offset |-> 0,crash_count |-> 0,emitted |-> <<>>,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<1>>,framer_buf |-> <<>>]),
    ([read_offset |-> 0,file_content |-> <<>>,next_line_id |-> 2,alive |-> TRUE,checkpoint_gen |-> 1,rotated_content |-> <<>>,rotation_count |-> 1,rotated_active |-> FALSE,in_flight_offset |-> 0,checkpoint_offset |-> 1,crash_count |-> 0,emitted |-> <<1>>,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>])
    >>
----
...
---- CONFIG MCFileCheckpoint_TTrace_1775196577 ----
CONSTANTS
    MaxLines = 4
    MaxBatches = 2
    MaxCrashes = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Apr 03 06:09:38 UTC 2026