---- MODULE MCFileCheckpoint_TTrace_1775196477 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MCFileCheckpoint_TTrace_1775196477.json", _TETrace)
...
\*
\*trace == IODeserialize("MCFileCheckpoint_TTrace_1775196477.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([read_offset |-> 0,file_content |-> <<1, 2>>,next_line_id |-> 3,alive |-> TRUE,checkpoint_gen |-> 0,rotated_content |-> <<>>,rotation_count |-> 0,rotated_active |-> FALSE,in_flight_offset |-> 0,checkpoint_offset |-> 0,crash_count |-> 0,emitted |-> <<>>,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>]),
    ([read_offset |-> 0,file_content |-> <<1, 2, 3>>,next_line_id |-> 4,alive |-> TRUE,checkpoint_gen |-> 0,rotated_content |-> <<>>,rotation_count |-> 0,rotated_active |-> FALSE,in_flight_offset |-> 0,checkpoint_offset |-> 0,crash_count |-> 0,emitted |-> <<>>,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>]),
    ([read_offset |-> 0,file_content |-> <<1, 2, 3, 4>>,next_line_id |-> 5,alive |-> TRUE,checkpoint_gen |-> 0,rotated_content |-> <<>>,rotation_count |-> 0,rotated_active |-> FALSE,in_flight_offset |-> 0,checkpoint_offset |-> 0,crash_count |-> 0,emitted |-> <<>>,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>]),
    ([read_offset |-> 0,file_content |-> <<>>,next_line_id |-> 5,alive |-> TRUE,checkpoint_gen |-> 0,rotated_content |-> <<1, 2, 3, 4>>,rotation_count |-> 1,rotated_active |-> TRUE,in_flight_offset |-> 0,checkpoint_offset |-> 0,crash_count |-> 0,emitted |-> <<>>,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>]),
    ([read_offset |-> 0,file_content |-> <<>>,next_line_id |-> 5,alive |-> FALSE,checkpoint_gen |-> 0,rotated_content |-> <<1, 2, 3, 4>>,rotation_count |-> 1,rotated_active |-> FALSE,in_flight_offset |-> 0,checkpoint_offset |-> 0,crash_count |-> 1,emitted |-> <<>>,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>]),
    ([read_offset |-> 0,file_content |-> <<>>,next_line_id |-> 5,alive |-> TRUE,checkpoint_gen |-> 0,rotated_content |-> <<>>,rotation_count |-> 1,rotated_active |-> FALSE,in_flight_offset |-> 0,checkpoint_offset |-> 0,crash_count |-> 1,emitted |-> <<>>,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>])
    >>
----
...
---- CONFIG MCFileCheckpoint_TTrace_1775196477 ----
CONSTANTS
    MaxLines = 4
    MaxBatches = 2
    MaxCrashes = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Apr 03 06:07:59 UTC 2026