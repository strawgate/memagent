...
| `json_scanner.rs` | Streaming JSON field scanner via bitmask iteration, including JSON whitespace (`space`, `tab`, `CR`) boundary handling | Kani bounded (5 proofs) + proptest oracle + compliance regressions |
